...
import { ArrowLeft, Send, Ship, Globe, Shield, Award } from "lucide-react";
...
const ExportQuote = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Export Quote Request Submitted!",
        description: "Thank you for your interest. Our export team will contact you within 24 hours with a detailed quote and shipping information.",
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-orange-50">
      ...
      <main role="main">
        {/* Hero Section */}
        <section className="relative py-24 bg-gradient-to-br from-coral-600 via-coral-700 to-coral-800 text-white overflow-hidden">
          {/* Background Pattern */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute inset-0 bg-gradient-to-br from-coral-900/20 to-slate-900/20"></div>
            <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_25%_25%,rgba(249,115,22,0.1)_0%,transparent_50%)]"></div>
            <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_75%_75%,rgba(251,146,60,0.1)_0%,transparent_50%)]"></div>
          </div>
          <div className="container mx-auto px-6 relative z-10">
            <div className="max-w-4xl">
              ...
              <p className="text-fluid-lg md:text-fluid-xl text-sand-200 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                Get a personalized quote for our premium shrimp export services. Fill out the form below and our export team will contact you within 24 hours.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Quote Form */}
        <section className="py-24 bg-gradient-to-br from-white via-orange-50/30 to-coral-50/30 relative">
          {/* Background Pattern */}
              ...
              <Card className="shadow-xl border-0 bg-white/70 backdrop-blur-sm">
                <CardHeader className="text-center pb-8">
                  <CardTitle className="text-3xl font-serif text-ocean-900 mb-4">
                    Export Quote Request Form
                  </CardTitle>
                  <CardDescription className="text-lg text-muted-foreground">
                    Please provide detailed information about your export requirements
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-8">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <Input
                            ...
                            required
                            className="mt-1 focus:ring-2 focus:ring-coral-500"
                          />
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <Select value={formData.businessType} onValueChange={(value) => handleInputChange("businessType", value)}>
                            <SelectTrigger className="mt-1 focus:ring-2 focus:ring-coral-500">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            placeholder="e.g., Google search, trade show, referral"
                            className="mt-1 focus:ring-2 focus:ring-coral-500"
                          />
                        </div>
                      </div>
                    ...
                    <div className="pt-6 border-t">
                      <Button
                        ...
                        className="w-full bg-coral-600 hover:bg-coral-700 hover:scale-105 transition-all duration-300"
                      >
                        {isSubmitting ? (
                          <>
                          ...
                          <>
                            ...
                            Submit Export Quote Request
                          </>
                        )}
                      </Button>
                      <p className="text-sm text-muted-foreground text-center mt-4">
                        By submitting this form, you agree to our terms of service and privacy policy.
                        Our export team will contact you within 24 hours with shipping details and pricing.
                      </p>
                    </div>
                  </form>
                </CardContent>
